# Nurture Email Sequence — Part 2
## CPG Founders Group | Post-Resource Download / Newsletter Signup

**Trigger:** Any resource download tag applied OR newsletter signup — ONLY if `Nurture Complete` tag is NOT present.
**Unsubscribe trigger:** `Existing Contact to Nurture` tag (prevents existing contacts from entering this sequence)
**From:** Jeff Church
**Reply-to:** Jeff's email
**Sequence length:** 9 emails over ~30 days
**On completion:** Apply `Nurture Complete` tag → add to weekly newsletter segment
...
**Purpose:** Drive them to the featured blog post. Establish Jeff as the definitive CPG authority. Build the habit of opening his emails.
...
**Purpose:** Show what Babu actually does — not a generic chatbot pitch but a concrete look at the tool and why it's different. Lowest-friction paid offer.
...
**Purpose:** Generate replies. Turn subscribers into conversations. Warm leads.
...
**Purpose:** Social proof through Krystal's results. Introduce the flagship offer while engagement is still high.
...
**Purpose:** Teach one of Jeff's frameworks. Position the MBA as the full system — and it feels accessible after seeing the 90-Day price.
...
**Purpose:** Get them into the community. Community = long-term stickiness and retention.
...
**Purpose:** Clear, confident, no-pressure CTA. Lay out all offers. Invite them to raise their hand.
