// Single source of truth for Jade Chang Sheppard's onboarding agreement.
...
export const ENGAGEMENT = {
  clientName: "Jade Chang Sheppard",
  business: "Fermenteria",
...
export const WHATS_INCLUDED: string[] = [
  "A 2-hour 1:1 strategy deep dive to kick things off, where Jeff goes deep on your business and helps you build a strategic roadmap.",
  "A monthly 60-minute 1:1 session with Jeff to work through what's in front of you and keep the roadmap moving.",
  "Email support between calls, plus async work like feedback on your deck, model, and anything else you want eyes on.",
...
export const AGREEMENT_SECTIONS: { title: string; body: string }[] = [
  {
    title: "1. Services",
    body: "During the Term, Provider will deliver the advisory services described above: a one-time 2-hour strategy deep dive, one 60-minute monthly 1:1 with Jeff Church, reasonable email and async support between sessions, access to Babu Pro, the MBA for CPG modules, and Provider's templates and tools, and warm introductions where appropriate. Sessions are scheduled by mutual agreement. Provider takes a limited annual summer break; any affected sessions will be rescheduled in good faith so Client does not lose a monthly session.",
  },
  {
    title: "2. Term & Commitment",
    body: "This Agreement begins on the Effective Date and continues for an initial term of three (3) months (the \"Initial Term\"), which is a minimum commitment. After the Initial Term it automatically continues month-to-month until cancelled under Section 4.",
  },
  {
    title: "3. Fees & Payment",
    body: "$2,000 per month for each of the three (3) months of the Initial Term, then $1,500 per month for each month thereafter. Fees are billed monthly in advance via a recurring subscription auto-draft through Stripe, charged to the card or ACH payment method on file on each Billing Date. Fees are non-refundable, including for partial months.",
  },
  {
