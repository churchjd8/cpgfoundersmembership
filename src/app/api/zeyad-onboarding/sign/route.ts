...
// Records Zeyad's signed agreement by emailing a durable record (with the
...
export async function POST(request: Request) {
  try {
        ...
        body: JSON.stringify({
          ...
          html: `
            ...
            <table style="border-collapse:collapse;font-family:sans-serif;">
              ...
              <tr><td style="padding:8px;font-weight:bold;">Terms</td><td style="padding:8px;">$${ENGAGEMENT.initialFeeUsd}/mo for ${ENGAGEMENT.initialMonths} months ($${ENGAGEMENT.totalInitialUsd} total), then month-to-month at a rate agreed before the term ends</td></tr>
            </table>
    ...
    console.error("Zeyad onboarding sign error:", err);
    return NextResponse.json(
