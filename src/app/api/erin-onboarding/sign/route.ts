...
// Records Erin's signed agreement by emailing a durable record (with the
...
export async function POST(request: Request) {
  try {
        ...
        body: JSON.stringify({
          ...
          html: `
            ...
            <table style="border-collapse:collapse;font-family:sans-serif;">
              ...
              <tr><td style="padding:8px;font-weight:bold;">Terms</td><td style="padding:8px;">$${ENGAGEMENT.totalInitialUsd} for ${ENGAGEMENT.initialMonths} months ($${ENGAGEMENT.initialFeeUsd}/mo or $${ENGAGEMENT.payInFullUsd} paid in full), then $${ENGAGEMENT.ongoingFeeUsd}/mo month-to-month</td></tr>
            </table>
    ...
    console.error("Erin onboarding sign error:", err);
    return NextResponse.json(
