...
// Records Max's signed agreement by emailing a durable record (with the
...
export async function POST(request: Request) {
  try {
        ...
        body: JSON.stringify({
          ...
          html: `
            ...
            <table style="border-collapse:collapse;font-family:sans-serif;">
              ...
              <tr><td style="padding:8px;font-weight:bold;">Terms</td><td style="padding:8px;">$${ENGAGEMENT.totalInitialUsd} for ${ENGAGEMENT.initialMonths} months — friends &amp; family rate, down from $${ENGAGEMENT.standardTotalUsd} ($${ENGAGEMENT.initialFeeUsd}/mo or $${ENGAGEMENT.totalInitialUsd} paid in full), then month-to-month at a rate agreed before the term ends</td></tr>
            </table>
    ...
    console.error("Max onboarding sign error:", err);
    return NextResponse.json(
