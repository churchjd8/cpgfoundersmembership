...
import { ENGAGEMENT } from "@/lib/erin-agreement";
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-20 text-center">
      ...
      <h1 className="mt-6 font-serif text-3xl font-bold tracking-tight sm:text-4xl">
        {paid ? "You're all set, Erin." : "Almost there."}
      </h1>

      {paid ? (
        <p className="mt-4 text-muted leading-relaxed">
          Your agreement is signed and your payment is in. A receipt is on its way to
          your inbox. Jeff will be in touch to schedule your 2-hour strategy deep
          dive. Welcome aboard.
        </p>
      ) : (
        <p className="mt-4 text-muted leading-relaxed">
          Thanks, Erin. If your payment went through, you&apos;ll have a receipt in
      ...
      <div className="mt-8 rounded-xl border border-border bg-card p-6 text-left">
        ...
        <ol className="mt-3 space-y-2 text-sm text-muted">
          <li>1. Jeff sends over a bit of pre-work and books your 2-hour strategy deep dive.</li>
          <li>2. You get access to Babu Pro and the MBA for CPG modules.</li>
          <li>
            3. Your monthly 1:1s get scheduled. The intensive is $
            {ENGAGEMENT.totalInitialUsd.toLocaleString()} for {ENGAGEMENT.initialMonths}{" "}
            months, then month-to-month at $
            {ENGAGEMENT.ongoingFeeUsd.toLocaleString()}/mo.
          </li>
        </ol>
      </div>
