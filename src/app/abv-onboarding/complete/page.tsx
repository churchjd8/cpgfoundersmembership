...
import { ENGAGEMENT } from "@/lib/abv-agreement";
    ...
    <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-20 text-center">
      ...
      {paid ? (
        <p className="mt-4 text-muted leading-relaxed">
          Your agreement is signed and your payment is in. A receipt is on its way
          to your inbox. Jeff will be in touch to schedule your half-day VIP
          strategy deep dive. Welcome aboard.
        </p>
      ) : (
        <p className="mt-4 text-muted leading-relaxed">
          Thanks. If your payment went through, you&apos;ll have a receipt in your
          inbox shortly and Jeff will reach out to schedule your strategy deep
          dive. If you closed checkout before finishing, you can pick back up
          below.
        </p>
      )}
      ...
      <div className="mt-8 rounded-xl border border-border bg-card p-6 text-left">
        ...
        <ol className="mt-3 space-y-2 text-sm text-muted">
          <li>
            1. Jeff sends over the intake form and books your half-day VIP
            strategy deep dive.
          </li>
          ...
          <li>
            ...
            {ENGAGEMENT.initialMonths} months, then month-to-month at $
            {ENGAGEMENT.ongoingLowUsd.toLocaleString()}–$
            {ENGAGEMENT.ongoingHighUsd.toLocaleString()}/month at a rate you and
