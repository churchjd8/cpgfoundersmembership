...
import { BookingEmbed, BOOKING_URL } from "../intensive/booking-embed";

// Single-tier variant of /intensive: only the $5K/mo VIP option. Same funnel
// position (sent by hand after /apply, unlisted, noindexed) for founders we
// want pointed straight at the VIP tier rather than choosing between two.
// Source of truth for the offer is "Jeff Church Advisory - Offers One-Pager.md";
// that file, /intensive, this page, and the response email must move together.

export const metadata: Metadata = {
  title: "Working with Jeff Church - VIP Advisory",
  description:
    "Three months of VIP advisory with Jeff Church. The full breakdown of what's included, what it costs, and what happens after.",
...
const tier = {
  name: "3-Month VIP Advisory",
  price: "$5,000",
  total: "$15,000 total, billed monthly",
  blurb:
    "For founders who want Jeff close, with real face time and a deep, hands-on kickoff.",
  points: [
    {
...
const summary = [
  ...
  { label: "Warm industry intros", value: true },
  { label: "Monthly speaker series", value: true },
  { label: "Retailer + investor pitch slams", value: true },
  { label: "Founder community", value: true },
  { label: "ROI guarantee", value: true },
  { label: "After 3 months", value: "Month-to-month, $1,500–$4,000/mo" },
];
...
const steps = [
  ...
  },
  {
    n: "03",
    title: "We talk",
    body: "A short intro call to make sure it's a fit in both directions. If we're aligned, we get your kickoff with Jeff on the calendar.",
  },
];
...
export default function VipAdvisoryPage() {
  return (
    <>
      {/* ========== HERO ========== */}
      <section className="relative bg-foreground text-white overflow-hidden">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg text-white/70 leading-relaxed">
              What he does is a focused three-month VIP advisory. He gets deep in your
              business, builds the strategy and roadmap with you, and stays in your corner
              every other week while you execute.
            </p>
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-accent bg-card-flagship shadow-sm p-8 md:p-10">
            ...
            <p className="mt-8 pt-6 border-t border-border text-sm text-muted leading-relaxed">
              Plus everything in <strong className="text-foreground">Also included</strong>{" "}
              below.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-card border-y border-border">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">Also included</h2>
      ...
      {/* ========== AT A GLANCE ========== */}
      <section id="summary" className="py-16 md:py-24 scroll-mt-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">At a glance</h2>
          <p className="mt-4 text-muted leading-relaxed max-w-2xl">
            The whole engagement on one screen, so there are no surprises on the call.
          </p>

          <div className="mt-10 overflow-x-auto rounded-2xl border border-border">
            <table className="w-full min-w-[480px] text-left bg-card">
              <thead>
                <tr className="border-b border-border">
                  <th className="p-5 text-sm font-semibold text-muted w-1/2">&nbsp;</th>
                  <th className="p-5 text-sm font-bold bg-card-flagship">
                    3-Month VIP Advisory
                  </th>
                </tr>
              </thead>
              <tbody>
                {summary.map((row) => (
                  <tr key={row.label} className="border-b border-border last:border-0">
                    ...
                    <td className="p-5 text-sm text-muted align-top bg-card-flagship">
                      {row.value === true ? <Check /> : row.value}
                    </td>
                  </tr>
                ))}
              </tbody>
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 text-muted leading-relaxed">
              ...
              you&rsquo;re trying to hit, and whether this is the right move for you right
              now. If it isn&rsquo;t a fit, we&rsquo;ll tell you that too.
            </p>
