  ...
  },
  {
    ...
    points: [
      ...
      },
      {
        ...
        body: "You go to the front of the line. Gut-checks and feedback whenever you need them, with Jeff getting back to you first.",
      },
    ],
  },
];
...
const comparison = [
  ...
  { label: "Email & async support", a: true, b: "Priority, between calls" },
