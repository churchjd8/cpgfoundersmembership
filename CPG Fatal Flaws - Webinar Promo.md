...
Related: the post-registration delivery emails are already live in Kajabi. See "CPG Fatal Flaws - Event Email Flow.md".

## Send schedule

| # | Piece | Channel | When |
|---|---|---|---|
| 1 | Announcement post | LinkedIn | Tue Sep 8, morning |
| 4 | Group note | WhatsApp | Tue Sep 8 |
| 2 | Full-list email | Kajabi | Tue Sep 8 or Wed Sep 9 |
| 3 | Two-days-out post | LinkedIn | Mon Sep 14, morning |

Scheduling note: the Aug–Oct LinkedIn batch already has "What's Your Gross-To-Net?" queued for Tue Sep 8 and "Know Your Velocity Before Your Buyer Tells You" for Tue Sep 15. Suggest pushing Gross-To-Net to Thu Sep 10 (and the Coca-Cola story to the following week) so the webinar post owns Tuesday morning. The Mon Sep 14 post runs as an extra and does not need to displace anything.
...
Whether you're a first time CPG founder or a vet, there's something on that list you haven't hit yet. Better to hear it from me than learn it the expensive way.
