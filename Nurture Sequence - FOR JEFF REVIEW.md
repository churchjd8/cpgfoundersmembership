# New Contact Nurture Sequence — for your review
### 10 emails over 31 days · CPG Founders Group

Jeff — this replaces the old nurture sequence entirely. The old one was still selling the 90-Day Breakthrough and a $15K VIP Day, still calling Babu a "limited free beta," and still saying the WhatsApp group had two hundred people in it.
...
| # | Day | Email | The ask | Why it sits here |
|---|-----|-------|---------|------------------|
| 1 | 1 | **Orientation** — what to expect, permission to leave | Free resources | Sets the tone and gives them an easy exit up front |
| 2 | 4 | **Three seconds in the end zone** — the high school story | Follow on LinkedIn | Pure value, no pitch. Earns the right to sell later |
| 3 | 7 | **"Can I ask you for fifteen seconds?"** — the topic poll | Reply with 3 numbers | Replies early protect inbox placement for everything after |
| 4 | 11 | **Babu** — 40+ Gurus, Deep Research, the naming story | 10-day free trial | Lowest-friction thing you sell. First money ask |
| 5 | 15 | **"Nobody warns you about this part"** — July 3rd, 2018 | Join the WhatsApp group | Free and high value. Resets goodwill after the first ask |
| 6 | 19 | **The first number I'd look at** — gross margin architecture | MBA for CPG, $997 | Teaches a real framework standalone, then points at the system |
| 7 | 22 | **The part I almost didn't write** — the Nasdaq bell | Book waitlist | Free ask, keeps momentum, builds the launch list |
| 8 | 25 | **Krystal's raise** — $250K bridge in her first month | Apply to work with you | The only proof in the sequence. Sets up the close |
| 9 | 28 | **Why I'm still doing this at 64** — Kilimanjaro, the ledger, rehab | **Nothing** | Emotional peak. Deliberately no ask |
| 10 | 31 | **2 or 3 spots** — private advisory | Apply | The close. Lands right after the emotional peak |

**The shape:** value, value, cheap ask, offer, free, offer, free, proof, emotion, close.

Two things I'd hold firm on. The poll email goes early because replies are what keep you out of the promotions tab for the rest of the month. And email 9 has no link in it at all — the email right before the close should cost the reader nothing.

Every email ends with a PS that teases something the email itself didn't pitch, so nothing ever feels like a single-note sales push.
...
> Krystal has signed off on being named with this figure.
...
> No link anywhere in this one. That's on purpose.
